...
class APIs {
  ...
  static Future<void> createAndDownloadPdf(
      context,
      nameController,
      surnameController,
      emailController,
  ...
  static Future<void> createNewPanne(
  ...
  static Future<void> GetPanneByBD(
      BuildContext context, NumBonController) async {
    try {
      if (NumBonController.isEmpty) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:
                Text('s\'il vous plaît entrer le numero de votre bon de depot'),
          ),
        );
        return;
      }
